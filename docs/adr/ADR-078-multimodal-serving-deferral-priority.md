...
multimodal topic into the bundle's ranking as _deferred, gated on the vision lane's scheduling_,
...
| R7 | **Vision is an actively tracked development lane.** Three roadmap tracking issues are open (#564 vision, #565 audio, #566 Gemma-4); #564's first milestone is a CPU-only ViT-parity slice. The serve fail-closed of R1 is the _already-shipped API half_ of #649.                                                                                  | issue-state                            | `gh issue view 564/565/566` (all OPEN); #649 OPEN (umbrella), #641 CLOSED (fixed by #656)                                                                                                                                                |
