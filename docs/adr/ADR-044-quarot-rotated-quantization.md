...
| 3c   | next            | `quantize_quarot` binary tying 3a + 3b + the rotation math from PR #18. Owns the step-3c contract spelled out under §"Step 3c contract" below (rotation absorption in f64, RMSNorm fusion, lm_head materialization, forward-equivalence refuse-on-fail, Q4 bridge decision).                                                                                                                                                                                                  |
