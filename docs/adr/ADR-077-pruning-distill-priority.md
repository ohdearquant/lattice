...
- **P2 — validate BI-ranking against PPL on the hybrid (#495).** With #492's harness, measure the
  ...
  flags as unresolved in the literature; #495's own promote bar (scorer must not lose to hand masks
  by more than 0.2 PPL) is inherited.
