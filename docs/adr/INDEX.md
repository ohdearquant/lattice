...
| [091](ADR-091-learned-mixture-weights.md)                     | Learned mixture weights over a resident LoRA pool                                                            | Accepted (2026-09-17) | ADR-079                                                                        |
| [092](ADR-092-model-owned-decoder-execution.md)               | Model-owned decoder execution and a neutral serving boundary                                                 | Accepted (2026-09-17) | ADR-009, ADR-080, ADR-082, ADR-086, ADR-090                                    |
| [093](ADR-093-per-request-mixture-routing.md)                 | Mixture routing is decided per request, and a weight change does not rebuild the adapter                     | Accepted (2026-09-21) | ADR-091                                                                        |
| [094](ADR-094-where-the-routing-code-lives.md)                | Where the routing code lives, and what feeds it                                                              | Accepted (2026-09-21) | ADR-091, ADR-093                                                               |
