...
| [080](ADR-080-consolidation-duplicated-contracts.md) | Consolidation of Duplicated Numeric-Contract Helpers (Softmax, HTTP Serving, Decode Policy, GEMM Validation) | Implemented | ADR-058, ADR-064, ADR-066 |
