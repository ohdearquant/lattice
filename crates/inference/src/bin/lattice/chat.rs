...
#[cfg(feature = "metal-gpu")]
pub(super) fn load_q4_serve_config(
    dir: &std::path::Path,
) -> Result<(lattice_inference::model::qwen35_config::Qwen35Config, usize), String> {
    Ok((load_q4_config(dir)?, MetalChatBackend::MAX_CACHE_LEN))
}
