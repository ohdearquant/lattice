...
"#;
    ...
    const MSL_Q4_TILED_SOURCE: &str = concat!(
        ...
        "            Wtg[2*byte_i+0][ni]=half(float(packed&0x0f)*d+b);\n",
        "            Wtg[2*byte_i+1][ni]=half(float(packed>>4)*d+b); }\n",
