...
const CONSTRUCTION_EXEMPTIONS: &[(&str, &str)] = &[
    ...
    (
        "bin:lattice_serve:src/bin/lattice_serve.rs=>src/bin/lattice_serve.rs:1733:47",
        "load_model Q4 initialization belongs to a long-running server outside the bounded measurement-harness contract",
    ),
    (
        "bin:lattice_serve:src/bin/lattice_serve.rs=>src/bin/lattice_serve.rs:1753:47",
