...
`uv run --with mlx-lm python3 scripts/bench_decode_harness.py run --profile context_scaling`
(see "Context scaling" under
Development below for the full invocation).
