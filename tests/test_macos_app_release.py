...
class WorkflowContractTest(unittest.TestCase):
    def test_release_workflow_stages_all_assets_before_single_publish(self):
        ...
        self.assertIn("Release is already published", workflow)
        self.assertIn('[ "$ERROR_OUTPUT" = "release not found" ]', workflow)
        self.assertIn("Could not determine release state", workflow)
